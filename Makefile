...
PKG_SOURCES	=  tclimagebytes.c
PKG_OBJECTS	=  tclimagebytes.o
...
PKG_LIB_FILE	= libimagebytes0.4.so
PKG_LIB_FILE8	= libimagebytes0.4.so
PKG_LIB_FILE9	= libtcl9imagebytes0.4.so
PKG_STUB_LIB_FILE = libimagebytesstub0.4.a
...
top_builddir	= /home/danilo/Public/tcl-imagebytes
